...
load_template( SP_BASE_DIR . '/library/functions/functions-tgmpa.php'); // Register Plugin required with TGM_Plugin_Activation
...
if( !function_exists('sp_theme_setup') ) {
	...
	function sp_theme_setup(){
		...
		add_image_size( 'blog-post-medium', 560, 386, true );
		add_image_size( 'movie-post-thumb', 140, 208, true );
