...
if( !function_exists('sp_frontend_scripts_styles') ) {
	...
	function sp_frontend_scripts_styles() {
		...
		wp_enqueue_style('flexisel', SP_ASSETS . '/css/flexisel.css', false, SP_THEME_VERSION);
		...
		wp_enqueue_script('flexisel', SP_ASSETS . '/js/vendor/jquery.flexisel.js', array('jquery'), SP_THEME_VERSION, true);
